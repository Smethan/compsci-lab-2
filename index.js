...
// ANSWER: They both depend on the string size and end up with the same object
...
class Divide {
  ...
  divideNums(num1, num2) {
    let property = `${num1}${num2}`
    if (this.cache.hasOwnProperty(property)) {
      return this.cache[property]
    }
    let answer = num1/num2
    this.cache[property] = answer
    return answer
  }
}
...
// CODE HERE 
function noCacheDivideNums(num1, num2) {
...
let myDiv = new Divide

console.time("not memoized function time");
console.log(noCacheDivideNums(24,12))
console.log(noCacheDivideNums(24,12))
console.log(noCacheDivideNums(24,12))
console.log(noCacheDivideNums(24,12))
...
console.log(myDiv.divideNums(24,12))
console.log(myDiv.divideNums(24,12))
console.log(myDiv.divideNums(24,12))
console.log(myDiv.divideNums(24,12))
